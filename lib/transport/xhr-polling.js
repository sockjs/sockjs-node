...
module.exports = {
  routes: [
    { method: 'POST', path: '/xhr', handlers: [middleware.h_sid, middleware.h_no_cache, middleware.xhr_cors, xhr_poll], transport: true },
    { method: 'OPTIONS', path: '/xhr', handlers: [middleware.h_sid, middleware.xhr_cors, middleware.xhr_options], transport: true },
