...
module.exports = {
  routes: [
    { method: 'GET', path: '/jsonp', handlers: [middleware.h_sid, middleware.h_no_cache, jsonp], transport: true },
    { method: 'POST', path: '/jsonp_send', handlers: [middleware.h_sid, middleware.h_no_cache, middleware.expect_form, jsonp_send], transport: true },
  ]
};
